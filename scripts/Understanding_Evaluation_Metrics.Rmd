...
---
### 0. Introduction: Building The Logistic Model
...
### 4. What is KS Statistic and How to interpret KS Chart?
...
```
### 4.1. How to plot Kolmogorov Smirnov Chart in R?
...
#### Cross Validation with R: the caret package
